...
function [ best_fitness_value, best_scout_bee,FDO_convergence_curve ] = FDO( function_name, max_iteration, scout_bee_number, weightFactor )
...
FDO_convergence_curve = zeros(1,max_iteration);
for iterate = 1 : max_iteration
    ...
    FDO_convergence_curve(iterate) = fitness(getBestScoutBee(scouts).xs); 
end
