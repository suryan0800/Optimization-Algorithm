...
function_name='F15'; % Name of the test function that can be from F1 to F19 and cec01 t0 cec10 (Table 1,2 in the paper)
...
%scout_bee_number =30; % Number of search agents
%max_iteration = 500;
%init_pop = (upper_bound - lower_bound).*rand([scout_bee_number,dimensions]) + lower_bound;
global xx;
xx = [];
